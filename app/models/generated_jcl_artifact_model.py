...
class GeneratedJclArtifact(Base):
    __tablename__ = "generated_jcl_artifacts"
    ...
    jcl_purpose = Column(String(50), nullable=False) # "general", "vsam"
    artifact_type = Column(String(50), nullable=False) # "jcl_general", "jcl_vsam"
    ...
    def __repr__(self):
        return f"<GeneratedJclArtifact(id={self.id}, file_name='{self.file_name}', input_source_id={self.input_source_id})>"