...
class M204File(Base):
    ...
    m204_file_id = Column(Integer, primary_key=True, autoincrement=True)
    ...
    defined_in_input_source_id = Column(Integer, ForeignKey("input_sources.input_source_id", ondelete='SET NULL'), nullable=True, index=True)
    ...
    # Relationships
    project = relationship("Project", back_populates="m204_files", foreign_keys=[project_id])
